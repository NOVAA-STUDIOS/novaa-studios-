...
export default function Hero() {
  ...
  const { startProject, viewWork } = useProjectNavigation()
      ...
      <div style={{ position:'relative', zIndex:1, textAlign:'center', maxWidth:'820px', width:'100%' }}>
        ...
        <motion.div
          ...
          style={{
            ...
            padding:'8px 22px', borderRadius:'50px', marginBottom:'2.5rem',
            ...liquidGlass,
          }}
        >
          <span style={{
            ...
            background:'#0A84FF',
            boxShadow:'0 0 12px rgba(10,132,255,1)',
        ...
        >
          ...
          <br />
          <span style={{
            background:'linear-gradient(135deg, #FFD6C0 20%, #FFBFA0 80%)',
        ...
        >
          ...
          <motion.button
            ...
            style={{
              ...
              boxShadow:'0 0 0 0.5px rgba(10,132,255,0.3) inset, 0 8px 32px rgba(10,132,255,0.2), 0 1px 0 rgba(255,255,255,0.3) inset',
              color:'#fff', fontWeight:600, fontSize:'0.95rem',
              cursor:'pointer', letterSpacing:'0.2px', transition:'all 0.3s ease',
            }}
          >
            Start Your Project →
          </motion.button>
        ...
        >
          <span style={{ fontSize:'0.7rem', letterSpacing:'2.5px', textTransform:'uppercase', color:'rgba(255,255,255,0.2)' }}>
            Scroll
          </span>
          <motion.div
            animate={{ y:[0,6,0] }}
