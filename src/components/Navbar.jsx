...
export default function Navbar() {
  ...
  const navShadow = scrolled
    ? 'inset 0 1px 0 rgba(255,255,255,0.09), 0 20px 60px rgba(0,0,0,0.55), 0 1px 0 rgba(255,255,255,0.04) inset'
        ...
        <div style={{
          ...
          <div style={{ position: 'relative', flexShrink: 0 }}>
            ...
            <DropPanel
              ...
              isActive={isActive} go={go}
              startProject={startProject}
              topOffset="calc(100% + 14px)"
              width="300px"
            />
          </div>
        </div>
...
/* ─────────────────────────────────────────────
   HAMBURGER BUTTON
   Three lines — always visible, never collapse
───────────────────────────────────────────── */
  ...
  return (
    <motion.button
      ...
      style={{
        ...
        gap:                  '5px',      /* controls spacing between 3 lines */
        background:           open
    ...
    >
      {/*
        Three independent spans — each is a line.
        Line 0 rotates CW to form top arm of X.
        Line 1 fades out (middle).
        Line 2 rotates CCW to form bottom arm of X.
        `gap:5px` keeps them evenly spaced in closed state.
        When open, rotate + translate overrides spacing visually.
      */}
      <motion.span
        animate={open
          ? { rotate: 45,  y: 10, width: '20px' }
      ...
      {open && (
        <>
          ...
          >
            ...
            <div style={{
              height: '1px',
              background: 'linear-gradient(90deg, transparent 5%, rgba(99,102,241,0.8) 50%, transparent 95%)',
            }} />
